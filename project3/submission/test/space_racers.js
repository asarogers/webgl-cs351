...
// Planet variables
var g_planetGenerator
var g_planet
var g_planetVertices = []
var g_planetTexCoords = []
...
g_planetVertices = rockyPlanet.vertices
...
async function loadImageFiles() {
    g_planetTexture = new Image()
    g_planetTexture.src = "./resources/texture/earth.jpg"
    await g_planetTexture.decode()
...
function startRendering() {
    ...
    if (!setupVec(2, 'a_TexCoord', 0, g_planetVertices.length * FLOAT_SIZE)) {
        return
    }
