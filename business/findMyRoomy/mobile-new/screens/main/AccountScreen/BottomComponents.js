...
export const Substances = ({
  ...
  <View style={styles.modernSection}>
    <View style={styles.modernSectionHeader}>
      <View style={styles.sectionTitleContainer}>
        <Ionicons name="wine-outline" size={20} color="#F59E0B" />
    ...
    {editing.substances ? (
      ...
      >
        ...
        <SingleSelectEditor
          ...
          options={QUIZ.sections.substances.questions.alcohol_use.optionsOrder}
        ...
        <View style={styles.toggleContainer}>
          ...
          >
            ...
            >
              {profile.substances.substance_free_preference ? "Yes" : "No"}
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
