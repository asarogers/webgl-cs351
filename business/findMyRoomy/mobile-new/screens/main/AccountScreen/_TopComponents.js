...
export function Hero({
  ...
  // Check if there's a photo at the first index
  const firstPhoto = profile.photos && profile.photos.length > 0 && profile.photos[0]?.uri;
        ...
        <View style={styles.profileInfo}>
          {editing.profile ? (
            <>
              ...
              />
              {/* Show current location as non-editable */}
              <View
                style={[
                  styles.modernInput,
              ...
              <View style={styles.locationToggleContainer}>
                ...
                <Switch
                  ...
                  onValueChange={(enabled) => {
                    updateProfile((p) => ({ ...p, location_sharing: enabled }));
                  }}
