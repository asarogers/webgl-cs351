...
static const _Behaviors_type_support_symbol_names_t _Behaviors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tamir_interface, msg, Behaviors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tamir_interface, msg, Behaviors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tamir_interface, msg, Behaviors)() {
  return &::tamir_interface::msg::rosidl_typesupport_c::Behaviors_message_type_support_handle;
}
