...
#include "tamir_interface/msg/detail/behaviors__rosidl_typesupport_fastrtps_c.h"
...
using _Behaviors__ros_msg_type = tamir_interface__msg__Behaviors;
...
{
  const _Behaviors__ros_msg_type * ros_message = static_cast<const _Behaviors__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tamir_interface__msg__Behaviors;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const tamir_interface__msg__Behaviors * ros_message = static_cast<const tamir_interface__msg__Behaviors *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_tamir_interface__msg__Behaviors(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  tamir_interface__msg__Behaviors * ros_message = static_cast<tamir_interface__msg__Behaviors *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_tamir_interface__msg__Behaviors(cdr, ros_message);
}

static uint32_t _Behaviors__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tamir_interface__msg__Behaviors(
...
static size_t _Behaviors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tamir_interface__msg__Behaviors(
...
static message_type_support_callbacks_t __callbacks_Behaviors = {
  "tamir_interface::msg",
  "Behaviors",
...
static rosidl_message_type_support_t _Behaviors__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Behaviors,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tamir_interface, msg, Behaviors)() {
  return &_Behaviors__type_support;
}
