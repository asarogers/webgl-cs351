...
function rotateX90() {
    g_modelMatrix = new Matrix4().rotate(90, 1, 0, 0).concat(g_modelMatrix)
}

function rotateY90() {
    g_modelMatrix = new Matrix4().rotate(90, 0, 1, 0).concat(g_modelMatrix)
}

function rotateZ90() {
    g_modelMatrix = new Matrix4().rotate(90, 0, 0, 1).concat(g_modelMatrix)
}

function reset() {
    // reset to facing to the right such that Y is pointed away from the camera
